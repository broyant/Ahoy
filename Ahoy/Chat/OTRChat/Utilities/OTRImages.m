...
{
    NSString *initials = [self stringInitialsWithMaxCharacters:2 withString:username];
...
+ (NSString *)stringInitialsWithMaxCharacters:(NSUInteger)maxCharacters withString:(NSString *)string
{
    if (![string length]) {
        return nil;
    }
