...
- (CGRect)trackRect
{
    ...
    retValue.size = CGSizeMake(currentTrackImage.size.width, 15);
 ...
 -(CGRect) trackBackgroundRect
{
    ...
    trackBackgroundRect.size = CGSizeMake(_trackBackgroundImage.size.width, 15);
...
- (CGRect)thumbRectForValue:(float)value image:(UIImage*) thumbImage
{
    ...
    thumbRect.size = CGSizeMake(25, 35);
